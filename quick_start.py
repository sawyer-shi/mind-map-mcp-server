...
def show_project_info():
    ...
    print()
    print("✨ Main Features:")
    print("   • 🧠 Smart Content Analysis - Auto-adjusts viewport based on content complexity")
    print("   • 📐 Dynamic Viewport Sizing - Scales from 800x600 to 2400x1600 automatically")
    print("   • 🎯 High-DPI Rendering - Supports 1x to 3x scale factors for crisp images")
    print("   • ✨ Multiple Quality Levels - Choose from low/medium/high/ultra presets")
